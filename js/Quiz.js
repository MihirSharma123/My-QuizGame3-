 ...
 start(){
  ...
  play(){
    ...
    if(data!== undefined )  
      ...
      text("THOSE WITH THE GREEN NAME HAVE GIVEN THE CORRECT ANSWER",130,230);
     // Write a for loop statement and check the condition if the correct answer is equal to the contestant’s answer. 
      for(var plr in allContestants){
        ...
        display_Answers+=30;
        textSize(20);
        text(allContestants[plr].name + ":DSDFFSS " + allContestants[plr].answer, 250,display_Answers)
      }
    } 
  }
}